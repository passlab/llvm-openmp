 ...
 */
extern int  rex_rauto_init();
extern void rex_rauto_finalize();
extern void on_rex_rauto_thread_begin(int thread_id );
extern void on_rex_rauto_thread_end(int thread_id );
extern void on_rex_rauto_parallel_end();
extern void on_rex_rauto_parallel_begin(uint32_t requested_team_size);
