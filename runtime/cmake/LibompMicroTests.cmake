...
if(WIN32)
  ...
  libomp_append(libomp_test_touch_libs "${LIBOMP_PAPI_LIBRARY}" LIBOMP_USE_PAPI)
  if(APPLE)
    ...
    libomp_append(libomp_test_touch_ldflags "-Wl,-rpath,${LIBOMP_PAPI_LIBRARY_DIR}" LIBOMP_USE_PAPI)
  else()
...
if(CMAKE_SYSTEM_NAME MATCHES "FreeBSD")
  ...
  libomp_append(libomp_expected_library_deps libpapi.so LIBOMP_USE_PAPI)
